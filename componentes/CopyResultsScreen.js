...
export default class ResultScreen extends React.Component {
  ...
  renderRectangleList = () => {
    ...
    return(
      <View style={ [styles.bottomViewB, { alignSelf: 'center' }] }>
        <Text>Metas del banco</Text>
      </View>
    );
...
class ElementList extends PureComponent {
  ...
  renderBRectangle = () => {
    ...
    return(
      <View><Text>Metas del banco</Text></View>
    );
